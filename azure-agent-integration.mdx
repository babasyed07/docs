...
<CardGroup cols={2}>
  ...
  <Card title="Microsoft Entra Identity Store" icon="users" href="/microsoft-entra-identity-integration">
    Import users and groups from the same tenant so policies can name real identities.
  </Card>
</CardGroup>
