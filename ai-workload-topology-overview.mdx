...
<Tip>
  You also reach a store's topology from the **inventory**: click **Manage** on any entity and pick the policy store you want to open. See [The Inventory and Your Policy Stores](/ai-workload-getting-started#the-inventory-and-your-policy-stores).
</Tip>
