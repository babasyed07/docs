...
When you're building a policy store's topology, **Add from Repository** lets you pull in entities that are already in your **Reva inventory** — no re-onboarding needed. The inventory holds everything you've brought in via **Ingest**, **Discover** *(coming soon)*, or a previous manual onboard.
