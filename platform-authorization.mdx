...
description: "Define who can perform platform-level actions like creating, approving, and activating policy stores in Reva."
---
...
2. **Use the Policy Designer** – <a href="authorization-policy" className="text-blue-600 font-semibold">Build Authorization Policy</a>   
The Policy Designer offers a visual builder to define authorization rules.  
   ...
   <Info>**Example:** Permit `ALL` to perform `CreateDraft`, `EditDraft`, `SendForApproval`, and `View` on `ALL` resources.</Info>  
